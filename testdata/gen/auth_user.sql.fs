...
let CreateAuthUser (db: NpgsqlConnection) (arg: CreateAuthUserParams)  =
  ...
  |> Sql.parameters  [ "@email", Sql.string arg.email, "@password", Sql.string arg.password, "@first_name", Sql.string arg.first_name, "@last_name", Sql.string arg.last_name, "@username", Sql.string arg.username, "@is_staff", Sql.bool arg.is_staff, "@is_superuser", Sql.bool arg.is_superuser ]
  |> Sql.execute reader
...
let UpdateAuthUser (db: NpgsqlConnection) (arg: UpdateAuthUserParams)  =
  ...
  |> Sql.parameters  [ "@id", Sql.int arg.id, "@first_name", Sql.string arg.first_name, "@last_name", Sql.string arg.last_name ]
  |> Sql.execute reader
...
let UpdateAuthUserByEmail (db: NpgsqlConnection) (arg: UpdateAuthUserByEmailParams)  =
  ...
  |> Sql.parameters  [ "@email", Sql.string arg.email, "@first_name", Sql.string arg.first_name, "@last_name", Sql.string arg.last_name ]
  |> Sql.execute reader
...
let UpdateAuthUserRateLimitByEmail (db: NpgsqlConnection) (arg: UpdateAuthUserRateLimitByEmailParams)  =
  ...
  |> Sql.parameters  [ "@email", Sql.string arg.email, "@rate_limit", Sql.int arg.rate_limit ]
  |> Sql.execute reader
