...
let UpdateChatPrompt (db: NpgsqlConnection) (arg: UpdateChatPromptParams)  =
  ...
  |> Sql.parameters  [ "@id", Sql.int arg.ID; "@chat_session_uuid", Sql.string arg.ChatSessionUuid; "@role", Sql.string arg.Role; "@content", Sql.string arg.Content; "@score", Sql.float64 arg.Score; "@user_id", Sql.int arg.UserID; "@updated_by", Sql.int arg.UpdatedBy ]
  |> Sql.execute reader
